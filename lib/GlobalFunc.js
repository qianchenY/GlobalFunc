var GlobalFunc = (function(){
	...
	*/
	...
	/**
	 * [fn.addEvent] 添加dom事件
	 * @params el: dom对象, event: 事件名称, fn: 响应函数, bol: 是否冒泡执行
	 * @return null;
	 */
	 ...
	 * @params el: dom对象, event: 事件名称, fn: 响应函数
	 * @return null;
	 */
	 ...
	 * @params data: [{name: 'a', id: '1' : children: [{name: 'a1', id: '11'}]}, {name: 'b', id : '2'}], wrap: 父元素, haslink: 是否添加链接
	 * @return Element;
	 */
