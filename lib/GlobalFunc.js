var GlobalFunc = (function(){
	...
	*/
	...
	/**
	 * [fn.arrToTree] 扁平数据结构转tree
	 * @param arr: arr = [ {id: 1, name: '部门1', pid: 0}, {id: 2, name: '部门2', pid: 1}, {id: 3, name: '部门3', pid: 1}, {id: 4, name: '部门4', pid: 3}, {id: 5, name: '部门5', pid: 4}, ]
	 * @param pid: 0;
	 * @return [{..., children: [..., children[]]}, ...]
	*/
	GlobalFunc.prototype.arrToTree = function(arr, pid){
		var narr = [];
			
		var _flat = (data, result, pid) => {
			for(let item of data){
				if(item.pid == pid){
					...
					_flat(data, newItem.children, item.id)
				}
			}
		}
		_flat(arr, narr, pid);
